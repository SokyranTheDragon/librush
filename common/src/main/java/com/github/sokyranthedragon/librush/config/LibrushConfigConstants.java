...
public class LibrushConfigConstants
{
    ...
    public static final String BASE_BRUSH_SWEEP_DURATION_KEY = CONFIG_PREFIX + BASE_BRUSH_SWEEP_DURATION_ID;
    public static final String BASE_BRUSH_SWEEP_DURATION_TOOLTIP = "Duration of a single brush sweep, in ticks.";

    public static final String BASE_BRUSH_SWEEPS_TO_FINISH_ID = "base_brush_sweeps_to_finish";
    public static final String BASE_BRUSH_SWEEPS_TO_FINISH_KEY = CONFIG_PREFIX + BASE_BRUSH_SWEEPS_TO_FINISH_ID;
}
